...
vim.g.mason_disable_ruff = false
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          --     end
          --
          --     if client and client.server_capabilities.formattingProvider then
      ...
      local servers = {
        ...
        -- buildFlags = {},               -- List of flags for 'go list', e.g. {"-tags=integration"}
        -- env = {},                      -- Map of env vars for commands run by gopls
        -- local = "",                    -- Prefix for import grouping like goimports -local
        -- annotations = {},                 -- Compiler optimization diagnostics (bounds, inline, etc.)
        -- -- SEMANTIC TOKENS (Syntax highlighting)
        -- semanticTokens = false,           -- Enable overall semantic tokens
        -- noSemanticString = false,         -- Turn off string tokens (use SemanticTokenTypes)
        -- noSemanticNumber = false,         -- Turn off number tokens
        -- semanticTokenTypes = {},          -- Map[string]bool to disable types
        -- semanticTokenModifiers = {},      -- Map[string]bool to disable modifiers
        --
        ...
        --
        -- -- DEBUGGING
        -- verboseOutput = false,            -- Turn on verbose logging in gopls
        -- completionBudget = "100ms",       -- (duplicate) Soft latency limit
        -- },
        --       --
        --       --
        --
        ...
        --           ['.*'] = 'https://github.com/joshmedeski/sesh/raw/main/sesh.schema.json',
        --         },
        --       },
        --     },
        --   },
